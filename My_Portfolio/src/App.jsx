...
function App() {
  ...
  return <>
    ...
    <main id="main">
      <section className="section hero" id="home"><div className="hero-content readability-panel"><ReadabilityLayer /><h1 className="hero-title"><span className="line">PARTH</span><span className="line">MEHTA</span></h1><p className="hero-tagline">Developer • Builder • Problem Solver</p><p className="hero-intro">Building interactive digital experiences and solving complex problems through code.</p><div className="hero-actions"><a href="#about" className="btn-primary">Explore my work ↓</a></div></div><div className="hero-scroll-cue" aria-hidden="true"><span className="stem" /><span>Scroll</span></div></section>
      ...
      <section className="section think" id="think"><h2 className="section-head">Think. Build. Solve.</h2><p className="think-statement readability-panel"><ReadabilityLayer />I enjoy algorithmic problem solving as much as I enjoy shipping software - breaking a hard problem into small, connected pieces is most of the work.</p><div className="network-wrap frame-corners"><canvas id="networkCanvas" ref={networkCanvas} /></div></section>
